...
# pkg_resources removed — resolve asset paths via os.path instead
_SAM3_PACKAGE_DIR = os.path.dirname(os.path.abspath(__file__))
import torch
...
def build_sam3_image_model(
    ...
    if bpe_path is None:
        bpe_path = os.path.join(
            _SAM3_PACKAGE_DIR, "assets", "bpe_simple_vocab_16e6.txt.gz"
        )
